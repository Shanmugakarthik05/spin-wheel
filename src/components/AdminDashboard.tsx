...
import { LogOut, Users, FileQuestion, Settings, Trophy, Timer } from 'lucide-react';
...
import CountdownControl from './admin/CountdownControl';
...
type TabType = 'teams' | 'questions' | 'rounds' | 'assignments' | 'countdown';
...
export default function AdminDashboard({ user, onLogout }: AdminDashboardProps) {
  ...
  const tabs = [
    ...
    { id: 'countdown' as TabType, label: 'Countdown', icon: Timer },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-xl border border-white/20 overflow-hidden">
            ...
            <div className="p-6">
              ...
              {activeTab === 'countdown' && <CountdownControl />}
